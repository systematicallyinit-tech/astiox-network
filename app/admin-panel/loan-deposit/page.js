      ...
      async function fetchTransactions() {
        try {
          ...
          const res = await axios.get(
            `/api/auth/admin/transactions/loan-deposit/loan?type=loan`,
            {
        ...
        const handleDelete = async (transaction) => {
          try {
            ...
            const res = await axios.delete(
              `/api/auth/admin/transactions/loan?id=${transaction._id}`,
              {
                withCredentials: true,
                headers: { "Content-Type": "application/json" },
              }
      ...
      const handleConfirm = async  (transaction) => {
          try {
            ...
            const res = await axios.patch(
              `/api/auth/admin/transactions/loan-deposit/loan?userId=${user._id}`,
              {
