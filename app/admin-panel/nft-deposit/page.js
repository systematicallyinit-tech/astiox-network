      ...
      async function fetchTransactions() {
        try {
          ...
          const res = await axios.get(
            `/api/auth/admin/transactions/nft-deposit/nft?type=nft`,
            {
        ...
        const handleDelete = async (transaction) => {
          try {
            ...
            const res = await axios.delete(
              `/api/auth/admin/transactions/nft-deposit/nft?id=${transaction._id}`,
              {
                withCredentials: true,
                headers: { "Content-Type": "application/json" },
              }
      ...
      const handleConfirm = async  (transaction) => {
          try {
            ...
            const res = await axios.patch(
              `/api/auth/admin/transactions/nft-deposit/nft?userId=${user._id}`,
              {
